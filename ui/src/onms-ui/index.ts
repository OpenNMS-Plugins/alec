...
// Vendored from OpenNMS/opennms ui/packages/onms-ui/src @ 5ebe7e2c828
// (origin/develop, 2026-08-12). @opennms/onms-ui is not yet published to a
// registry, so ALEC carries a copy; the '@opennms/onms-ui' import alias makes
// the published package a drop-in replacement later. Only this version line
// differs from upstream (the workspace package.json is not vendored).
export const ONMS_UI_VERSION: string = '0.3.0'
