 ...
 *
 * <p>Pricing constants are Sonnet 4.6 ephemeral-cache list price as of
 * 2026-05; if Anthropic moves these, also update {@link #PRICING_NOTE}.
 */
public class UsageStore {

    public static final String CONTEXT = "ALEC_CLAUDE_USAGE";

    // Sonnet 4.6 pricing, USD per million tokens.
    // Ephemeral (5-min) cache pricing: creation is 1.25x base input, read is 0.1x base input.
    ...
    static final String PRICING_NOTE = "Approximate cost using Sonnet 4.6 ephemeral-cache list price "
            + "(in $3/out $15/cache-read $0.30/cache-create $3.75 per 1M tokens). "
