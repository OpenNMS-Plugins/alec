...
public class EngineParameterImplTest {
    ...
    public void serializeSimpleString() throws JsonProcessingException {
        ...
        assertThat(json, equalTo("{\"engineName\":\"dbscan\",\"distanceMeasureName\":\"test\",\"alpha\":1.0,\"beta\":2.0,\"epsilon\":3.0,\"noPathDistance\":100.0,\"remoteUri\":null,\"token\":null,\"remote\":false}"));
    }
