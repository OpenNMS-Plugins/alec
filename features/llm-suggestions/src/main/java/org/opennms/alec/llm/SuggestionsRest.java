...
/**
 * Returns LLM-generated suggestions for a specific situation. Sits on the
 * same {@code @Path("alec/llm")} root as the slice-1 configuration endpoint
...
public interface SuggestionsRest {
    ...
    /**
     * Force a fresh LLM analysis for the given situation, bypassing the
     ...
     *         400 if LLM integration is disabled or no API key is set
     */
    @POST
