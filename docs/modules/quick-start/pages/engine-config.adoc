...
ALEC includes a DBSCAN-based clustering engine (with an experimental LLM-based clustering engine also available).
...
image::engine-config.png[Correlation engine selection prompt for the ALEC clustering engine, 900]
